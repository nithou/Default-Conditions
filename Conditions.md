...
**Date de révision :** 30 septembre 2013
...
### 2.1 Maquette de site

Dans le cas où je ne prends en charge que le développement visuel de votre site, une maquette vous sera fournie soit au format Photoshop (CreativeCloud), soit dans un format vectoriel, soit au format HTML5 & CSS 2.1 + 3.
...
### 2.3 Gestion de Contenu

Une fois votre maquette validée, elle sera intégrée au système de gestion de contenu défini par mes soins selon vos besoins (rapidité, compatibilité, technologies nécessaires & fonctionnalités).

### 2.4 Tests sur navigateurs
...
## 6. Délais d'impressions & qualité

Je mettrai tout en oeuvre pour **sélectionner le meilleur imprimeur** pour votre travail (si un imprimeur est nécessaire), et même si je ferai tout pour m'assurer du respect de vos délais, je ne peux être tenu responsable d'une prise de retard du côté de l'imprimeur sélectionné.

## 7. Prestataires extérieurs
...
Je ne peux garantir que mon travail sera sans erreur, et ainsi ne peux être tenu responsable envers vous ou tout autre tiers pour des préjudices incluant la perte de profits, la perte d’épargne, ou toute autre dommage-intérêts indirects ou spéciaux, même dans le cas où vous m'auriez informé de cette possibilité. Enfin, si l’une des clauses de ce contrat devait être illégale, nulle ou inapplicable pour quelque raison que ce soit, alors cette clause devra être jugée séparément et ne remettra en aucun cas la validité et l’applicabilité des clauses restantes dans ce contrat.
...
Dans ce document vous seront cédés les droits de représentation, d'exploitation, de traduction, de reproduction, d'adaptation, de représentation et d'enregistrement sur le travail produit.
...
Vous ne pouvez transférer ce contrat à quiconque sans ma permission. Ce contrat reste valide et ne nécessite pas de renouvellement. Si, pour quelque raison que ce soit, une des clauses de ce contrat devenait non valide ou inapplicable, le reste des clauses resterait en place.

Bien que le langage utilisé ici est simple, les intentions sont sérieuses et ce contrat est un document légal et exclusivement soumis au droit belge.

## 19. Le grand final

En signant votre contrat, vous acceptez les conditions mentionnées ci-dessus, à partir de la date mentionnée dans votre contrat. Les dernières versions de ces conditions sont à tout moment accessible [via ce lien](https://github.com/nithou/Default-Conditions/blob/master/Conditions.md). 
